...
public class Tests_Export_DataTable(ITestOutputHelper testHelper)
{
    [Theory]
    [InlineData("xlsx")]
    [InlineData("csv")]
    public void ExportDataTable_FilePath(string extension)
    {
        string filePath = FileHelper.GenExportFilePath(extension);

        DataTable data = MockData.GetDataTable();
    ...
    [InlineData("xlsx")]
    [InlineData("csv")]
    public async Task ExportDataTableAsync_FilePath(string extension)
    {
        string filePath = FileHelper.GenExportFilePath(extension);
